...
def download(short_name: str, version: str, temporal:str, bbox:str,
    ...
    #print('Waiting 10 seconds for filesystem to find file...')
    #time.sleep(10)  # TODO investigate further, this is a hack to prevent the filesystem from not finding the moved files, fixed below by just saving file name...
