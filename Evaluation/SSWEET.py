...
def parityplot(EvalDF, savfig, watershed, date):   

    Title = f"SWEMLv2.0 Model Performance {date} \n {watershed} River Basin"
    figname = f"./SWEMLv2.0/Evaluation/Figures/{watershed}_parity_{date}.png"
...
def Model_Vs(EvalDF,metric,model_output,savfig, watershed, date):   

    figname = f"./SWEMLv2.0/Evaluation/Figures/{watershed}_{metric}_{model_output}_{date}.png"
